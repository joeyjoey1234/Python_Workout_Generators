...
workout1 = {
    ...
    ## Percentage based off week, Weight based off percentage, sets & reps based off Percentage
    'Deadlift:': 'Percentage:{}%, Wieght:{}Lb,sets & reps:{}'.format(this_weeks_main_percentage,
                                                                     (Deadlift_max * this_weeks_main_percentage),
                                                                     Main_lift_Sets_reps[this_weeks_main_percentage]),
    'Bench Press:': 'Percentage:{}%, Wieght:{}Lb,sets & reps:{}'.format(this_weeks_main_percentage,
...
workout2 = {
    ## Percentage based off week, Weight based off percentage, sets & reps based off Percentage
    'Squat:' : 'Percentage: .60%, Wieght:{}Lb,sets & reps:{}'.format((Squat_max * .60),acc_lift_Sets_reps[week]),
    ## Percentage based off week, Weight based off percentage, sets & reps based off Percentage
    'Deadlift:' : 'Percentage: .60%, Wieght:{}Lb,sets & reps:{}'.format((Deadlift_max * .60),acc_lift_Sets_reps[week]),
    'Bench Press:' : 'Percentage: .60%, Wieght:{}Lb,sets & reps:{}'.format((bench_max * .60),acc_lift_Sets_reps[week]),
    ## Percentage based off week, Weight based off percentage, sets & reps based off Percentage
    ## ab exercises are more about sets and reps
    ab_exer[random.randrange(0, 11, 1)]: 'Sets&Reps:{}'.format(ab_exer_sets_reps[week]),
    carryover[random.randrange(0, 9, 1)]: 'Percentage:{}%, Sets&Reps:{}'.format(this_weeks_acc_percentage,
...
workout_pick = [workout1,workout2]

This_weeks_workout = [workout_pick[0],workout_pick[1],workout_pick[0],workout_pick[1]]
